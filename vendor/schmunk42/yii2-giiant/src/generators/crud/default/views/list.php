...
<div class="easyui-layout" style="width:100%;height:100%;">
    <div data-options="region:'north'" style="height:50%;overflow: hidden">
        <table id="tt"
               ...
               url="<?= "<?=" ?> \yii\helpers\Url::to(["list-data"]) ?>"
               title="Data <?= \yii\helpers\Inflector::camel2words(StringHelper::basename($generator->modelClass)) ?>"
...
<script>
    ...
    $("#btn-delete").click(function(){
        $.ajax({
            url : "<?= "<?=" ?> Url::to(["delete"]) ?>?id=" + currentID,
            data : $("#form").serialize(),
            success : function(msg){
