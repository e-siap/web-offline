...
class RealUploader {
    ...
    public function __construct()
    {
        ...
        $this->setUploadPath(__DIR__."/uploads/");
        ...
        $this->denyExtensions = ['php','php3', 'php4', 'php5', 'phtml', 'exe', 'pl', 'cgi', 'html', 'htm', 'js', 'asp',
            'aspx', 'bat', 'sh', 'cmd', 'jsp'];
    }
    ...
    private function checkName() {
        $windowsReserved = ['CON', 'PRN', 'AUX', 'NUL','COM1', 'COM2', 'COM3', 'COM4', 'COM5', 'COM6', 'COM7', 'COM8',
